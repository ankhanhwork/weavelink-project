...
- Demo amounts must be positive and at most 9999999999 VND, satisfying the protocol's scaled 12-digit amount field; reject out-of-range order totals before payment. Only ORDER checkout is supported, including the applicable design-fee line; design requests create no standalone SERVICE transaction.
