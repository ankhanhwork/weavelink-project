...
| DBIZ2 source | Function List `MFG-12`, No. 87-94, `F-SYS-001` .. `F-SYS-008`; Use Cases: Monitor system logs; Backup & restore data; Configure system; [NEEDS CLARIFICATION: Use Case IDs are not visible in the supplied table.]; Screens: `S39`, `S40` |
...
| 3. US-1 | Use Case “Monitor system logs” (original ID unavailable) | `docs/architecture/use-case.md`, line 49 |
| 3. US-2 | Use Case “Backup & restore data” (original ID unavailable) | `docs/architecture/use-case.md`, line 50 |
| 3. US-3 | Use Case “Configure system” (original ID unavailable) | `docs/architecture/use-case.md`, line 51 |
