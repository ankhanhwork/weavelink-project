...
| DBIZ2 source | Function List `MFG-03`, No. 17-24, `F-ACC-001` .. `F-ACC-008`; Use Cases: Add account; Update account info & role; Delete account; Manage company's user accounts; [NEEDS CLARIFICATION: Use Case IDs are not visible in the supplied table.]; Screens: [NEEDS CLARIFICATION: No matching Screen IDs are supplied.] |
...
| 3. US-1 | Use Case “Add account” (original ID unavailable) | `docs/architecture/use-case.md`, line 45 |
| 3. US-2 | Use Case “Update account info & role” (original ID unavailable) | `docs/architecture/use-case.md`, line 46 |
| 3. US-3 | Use Case “Delete account” (original ID unavailable) | `docs/architecture/use-case.md`, line 47 |
| 3. US-4 | Use Case “Manage company's user accounts” (original ID unavailable) | `docs/architecture/use-case.md`, line 48 |
