...
| DBIZ2 source | Function List `MFG-02`, No. 12-16, `F-PROF-001` .. `F-PROF-005`; Use Cases: View Profile; Manage profile; Edit Profile; Change password; Use Case IDs: UC-M05, UC-M06, UC-M07, UC-M08; Screens: `S03`, `S06`, `S07`, `S38` |
...
| 3 | Use Case IDs: UC-M05, UC-M06, UC-M07, UC-M08 | Unassessed; see final question | Unassigned; see final question | Open |
...
| 3. US-1 | Use Case “View Profile” (UC-M05) | `docs/architecture/use-case.md`, line 10 |
| 3. US-2 | Use Case “Manage profile” (UC-M06) | `docs/architecture/use-case.md`, line 11 |
| 3. US-3 | Use Case “Edit Profile” (UC-M07) | `docs/architecture/use-case.md`, line 12 |
| 3. US-4 | Use Case “Change password” (UC-M08) | `docs/architecture/use-case.md`, line 13 |
