...
|---|---|
| MFG-02/F-PROF-004 | Implements this screen's validated user flow and the linked source function. |
| MFG-02/F-PROF-005 | Implements this screen's validated user flow and the linked source function. |
